...
<form action="#" method="POST" name="forminputtanggal" enctype="multipart/form-data">
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr height="36">
			<td>&nbsp;</td>
			<td>Tanggal</td>
			<td><input name="tgl_upload" value="" size="24">&nbsp;<a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.forminputtanggal.tgl_upload);return false;" ><img name="popcal" align="absmiddle" src="tugas akhir/calender/calbtn.gif" width="34" height="22" border="0" alt=""></a></td>
		</tr>
		<tr height="36">
			<td>&nbsp;</td>
			<td>&nbsp;</td>
